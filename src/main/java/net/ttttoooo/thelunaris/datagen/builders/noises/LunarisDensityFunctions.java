...
public class LunarisDensityFunctions {
    ...
    public static void bootstrap(BootstapContext<DensityFunction> context) {
        ...
        HolderGetter<DensityFunction> holdergetter1 = context.lookup(Registries.DENSITY_FUNCTION);
	        ...
	        Holder<DensityFunction> holder = context.register(CONTINENTS, DensityFunctions.flatCache(DensityFunctions.shiftedNoise2d(densityfunction, densityfunction1, 0.25D, holdergetter.getOrThrow(LunarisNoise.CONTINENTALNESS))));
	        Holder<DensityFunction> holder1 = context.register(EROSION, DensityFunctions.flatCache(DensityFunctions.shiftedNoise2d(densityfunction, densityfunction1, 0.25D, holdergetter.getOrThrow(LunarisNoise.EROSION))));
	        ...
	        DensityFunction densityfunction3 = DensityFunctions.noise(holdergetter.getOrThrow(LunarisNoise.JAGGED), 1500.0D, 0.0D);
    ...
    public static DensityFunction peaksAndValleys(DensityFunction p_224438_) {
    ...
    public static DensityFunction spaghettiRoughnessFunction(HolderGetter<NormalNoise.NoiseParameters> p_255763_) {
    ...
    public static DensityFunction entrances(HolderGetter<DensityFunction> p_256511_, HolderGetter<NormalNoise.NoiseParameters> p_255899_) {
    ...
    public static DensityFunction noodle(HolderGetter<DensityFunction> p_256402_, HolderGetter<NormalNoise.NoiseParameters> p_255632_) {
    ...
    public static DensityFunction pillars(HolderGetter<NormalNoise.NoiseParameters> p_255985_) {
       double d0 = 25.0D;
       double d1 = 0.3D;
    ...
    public static DensityFunction spaghetti2D(HolderGetter<DensityFunction> p_256535_, HolderGetter<NormalNoise.NoiseParameters> p_255650_) {
    ...
    public static DensityFunction weirdScaledSampler(DensityFunction p_208316_, Holder<NormalNoise.NoiseParameters> p_208317_, LunarisDensityFunctions.WeirdScaledSampler.RarityValueMapper p_208318_) {
        return new LunarisDensityFunctions.WeirdScaledSampler(p_208316_, new DensityFunction.NoiseHolder(p_208317_), p_208318_);
     }
    
    public static record WeirdScaledSampler(DensityFunction input, DensityFunction.NoiseHolder noise, LunarisDensityFunctions.WeirdScaledSampler.RarityValueMapper rarityValueMapper) implements LunarisDensityFunctions.TransformerWithContext {
        ...
        public static enum RarityValueMapper implements StringRepresentable {
           TYPE1("type_1", LunarisDensityFunctions.QuantizedSpaghettiRarity::getSpaghettiRarity3D, 2.0D),
           TYPE2("type_2", LunarisDensityFunctions.QuantizedSpaghettiRarity::getSphaghettiRarity2D, 3.0D);
